  ...
  return (
    <>
      <input
        id={id}
        className={
          `mr-2 mt-[0.3rem] h-3.5 w-8 appearance-none rounded-[0.4375rem] ${darkTrackOffColor} bg-neutral-300 ` +
          ...
          `${darkToggleOffColor} ${darkTrackOnColor} ${darkToggleOnColor} dark:focus:before:shadow-[3px_-1px_0px_13px_rgba(255,255,255,0.4)] dark:checked:focus:before:shadow-[3px_-1px_0px_13px_#3b71ca] `+
          `${darkTrackDisabledColor}`
        }
        type="checkbox"
        role="switch"
        {...props}
